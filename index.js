                        ...
                        async function addParticipants() {
                            ...
                            var options = {
                                ...
                                headers: {
                                    ...
                                    "content-length": "",
                                    cookie:
                                        "__cfduid=db8b5d7601d0987d750f98fbdf7ac844c1556741043",
                                    Host: "api.challonge.com",
                                    "Cache-Control": "no-cache",
                                    Accept: "*/*",
                                    Authorization: authorize,
                ...
                async function getMatches() {
                    async function nameRequest(id1, id2, match) {
                        ...
                        setTimeout(function () {
                            bot.sendMessage({
                                to: channelID,
                                message: `***Match ID:*** ${match} ***Player's***:  ${name1} ***vs*** ${name2}`,
                            });
                        }, 500);
                    }
                    let tournamentID;
                    ...
                    request(options, function (error, response, body) {
                        ...
                        if (body.indexOf("html") !== -1) {
                            bot.sendMessage({
                                to: channelID,
                                message:
                                    "No open matches, Make sure the tournament has started",
                            });
                        ...
                        async function setWinner() {
                            ...
                            var options = {
                                ...
                                headers: {
                                    ...
                                    "content-length": "",
                                    cookie:
                                        "__cfduid=d592765a893adb2a2d35f906c25153bf11563208454",
                                    Host: "api.challonge.com",
                                    "Cache-Control": "no-cache",
                                    Accept: "*/*",
                                    Authorization: authorize,
